...
public class EventController {
    ...
    public ResponseEntity<ApiResponse<List<EventResponse>>> getEventsByCreator(@PathVariable Long userId) {
        return ResponseEntity.ok(ApiResponse.ok("Creator events", eventService.getEventsByCreator(userId)));
    }
